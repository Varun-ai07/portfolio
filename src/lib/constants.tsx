...
export const PROJECTS: Project[] = [
    {
        ...
        description: "Hybrid CNN + Vision Transformer architecture for MRI-based brain tumor classification achieving 94% accuracy across 4 tumor types with Grad-CAM visualizations.",
        category: "Medical AI",
