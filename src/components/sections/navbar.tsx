  ...
  return (
    <>
      <motion.nav
        ...
        className="fixed top-0 left-0 w-full z-50 h-[68px] flex items-center justify-between px-6 md:px-10 bg-black/80 backdrop-blur-md border-b border-[#333333]/50"
      >
        {/* Left: Dynamic Time */}
